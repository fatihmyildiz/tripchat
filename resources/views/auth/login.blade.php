                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-sm-8">
                        <div class="edit-profile">
                            <div class="edit-profile__logos">
                                <img class="dark" src="{{ asset('assets/img/logochat.png') }}" alt="">
                                <img class="light" src="{{ asset('assets/img/logowhitechat.png') }}" alt="">
                            </div>
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="edit-profile__title">
                                        <h6>Sign in Chattrip</h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('authenticate') }}" method="POST">
                                        ...
                                        <div class="edit-profile__body">
                                            <div class="form-group mb-20">
                                                ...
                                                <input type="text" class="form-control" id="email" name="email" value="admin@isodeco.nl" placeholder="Email address">
                                                @if($errors->has('email'))

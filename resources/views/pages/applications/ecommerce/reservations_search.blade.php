                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="userDatatable orderDatatable global-shadow py-30 px-sm-30 px-20 radius-xl w-100 mb-30">
                                ...
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    ...
                                    <div class="project-category d-flex align-items-center ms-md-30 mt-xxl-10 mt-15">
                                       ...
                                       <ul class="nav px-1" id="ap-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('reservation.reservations', ['language' => app()->getLocale()]) }}"><i class="la la-times btn-secondary"></i></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link{{ request()->routeIs('reservation.reservationsearch') && $status === null ? ' active' : '' }}" href="{{ route('reservation.reservationsearch', ['language' => app()->getLocale(), 'status' => null, 'search' => $search]) }}">Hepsi</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link{{ request()->routeIs('reservation.reservationsearch') && $status === '0' ? ' active' : '' }}" href="{{ route('reservation.reservationsearch', ['language' => app()->getLocale(), 'status' => '0', 'search' => $search]) }}">Giriş Bekleniyor</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link{{ request()->routeIs('reservation.reservationsearch') && $status === '1' ? ' active' : '' }}" href="{{ route('reservation.reservationsearch', ['language' => app()->getLocale(), 'status' => '1', 'search' => $search]) }}">Giriş Yaptı</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link{{ request()->routeIs('reservation.reservationsearch') && $status === '3' ? ' active' : '' }}" href="{{ route('reservation.reservationsearch', ['language' => app()->getLocale(), 'status' => '3', 'search' => $search]) }}">İşletme İptali</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link{{ request()->routeIs('reservation.reservationsearch') && $status === '2' ? ' active' : '' }}" href="{{ route('reservation.reservationsearch', ['language' => app()->getLocale(), 'status' => '2', 'search' => $search]) }}">Müşteri İptali</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link{{ request()->routeIs('reservation.reservationsearch') && ($status === '4' || $status === '5') ? ' active' : '' }}" href="{{ route('reservation.reservationsearch', ['language' => app()->getLocale(), 'status' => '4', 'search' => $search]) }}">Tamamlandı</a>
                                        </li>
                                    </ul>
                          ...
                          <script>
    // JavaScript ile status ve search parametrelerini pagination linklerine eklemek
    document.querySelectorAll('.pagination a').forEach(function(link) {
        // Mevcut href değerini al
        let href = link.getAttribute('href');
        
        // Eğer href içinde "?" karakteri varsa, "&" ekleyerek yeni parametreyi ekle
        // Eğer "?" karakteri yoksa, "?" karakterini ekleyerek yeni parametreyi ekle
        let separator = href.includes('?') ? '&' : '?';
        
        // Yeni href değerini oluştur
        link.href = href + separator + "status={{ $status }}&search={{ $search }}";
    });
</script>

<nav class="navbar navbar-light">
    <div class="navbar-left">
        <div class="logo-area">
            <a class="navbar-brand" href="{{ auth()->check() && (auth()->user()->role == 1 || auth()->user()->role == 2) ? route('dashboard.admin_homepage', app()->getLocale()) : route('dashboard.mod_homepage', app()->getLocale()) }}">
                ...
                <div class="dropdown-custom">
                    ...
                    @if(isset($find_customer))
                        @foreach ($find_customer as $customer)
                            <div class="dropdown-wrapper dropdown-wrapper--small">
                                ...
                                <a href="{{ route(Route::currentRouteName(),['tr',$customer->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> Turkish</a>
                    ...
                    @else
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            ...
                            <a href="{{ route(Route::currentRouteName(),'tr') }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> Turkish</a>
